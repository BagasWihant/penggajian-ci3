...
<div id="wrapper">
	...
	<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
		...
		<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
			...
			<div class="sidebar-brand-text mx-3">Penggajian<sup>2</sup></div>
		</a>
		...
		<li class="nav-item">
			<a class="nav-link"href="<?= base_url('admin/potongGaji')?>">
				<i class="fas fa-fw fa-table"></i>
				<span>Potong gaji</span></a>
		</li>
		...
		<li class="nav-item">
			<a class="nav-link"href="<?= base_url('admin/lapGaji')?>">
				<i class="fas fa-fw fa-table"></i>
	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div id="content">
			...
			<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
				...
				<!-- Topbar Search -->
				<h4 class="font-weight-bold">Wihant Corp</h4>
